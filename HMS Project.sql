...
CREATE TABLE Membership (
    ...
    MembershipType ENUM('Silver', 'Gold', 'Platinum', 'Diamond') NOT NULL,
    DiscountRate DECIMAL(5,2) DEFAULT 0.00, 
    Status ENUM('Active', 'Expired', 'Suspended') DEFAULT 'Active'
);
ALTER TABLE Membership ADD COLUMN GuestID INT NOT NULL, ADD CONSTRAINT GuestID
FOREIGN KEY (GuestID) REFERENCES Guest(GuestID);
ALTER TABLE Membership drop foreign key GuestID;
...
CREATE TABLE Staff (
    ...
    Position ENUM('Front Desk', 'Housekeeping', 'Maintenance', 'Management', 'Food & Beverage') NOT NULL,
    Status ENUM('Active', 'Inactive', 'On Leave') DEFAULT 'Active'
);
SELECT * FROM Staff;
ALTER TABLE Staff
MODIFY Position ENUM('Manager','Front Desk','Guard','Cleaner','Sweaper');
...
CREATE TABLE Payment (
    ...
    PaymentMethod ENUM('Credit Card', 'Debit Card', 'Cash', 'Online', 'Other') NOT NULL, 
...
CREATE TABLE Service(
    ...
    ServiceRecord ENUM('Pending', 'In Progress', 'Completed') NOT NULL,
    Price INT NOT NULL
);
...
-- ADD COLUMN WITH FOREIGN KEY REFERNCE
ALTER TABLE Membership ADD COLUMN GuestID INT NOT NULL, ADD CONSTRAINT GuestID
FOREIGN KEY (GuestID) REFERENCES Guest(GuestID);
